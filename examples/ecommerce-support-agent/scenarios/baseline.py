...
baseline_scenarios = [
    Scenario(
        ...
        assertions=[AllTurnsComplete(), CompletesWithin(60.0), MaxTotalLLMCalls(5)],
    ...
    Scenario(
        ...
        turns=[
            Turn(
                "Can I get a refund for order ORD-67890? The laptop stand doesn't fit my desk."
            ),
        ],
        assertions=[AllTurnsComplete(), CompletesWithin(60.0), MaxTotalLLMCalls(6)],
    ...
    Scenario(
        ...
        assertions=[AllTurnsComplete(), CompletesWithin(60.0), MaxTotalLLMCalls(4)],
